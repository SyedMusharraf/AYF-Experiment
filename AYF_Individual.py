...
for t in targets:
    ...
    plt.ylabel('features')
    plt.title(f"Features Importance graph of: {t}")
    plt.tight_layout()
    # plt.savefig(f'Individual_Features_{t}.png')

    
# print(f"the overall r2 is :{r2:.4f} ")
...
# exit()
    ...
    plt.title(f"{t} for actual v/s prediction values")
    plt.grid(True)
    # plt.savefig(f'Individual_Model_{t}.png')
